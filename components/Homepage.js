          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-left space-y-8 animate-fade-in">
              ...
              <p className="text-xl text-gray-600 max-w-xl transition-all duration-500 hover:text-gray-800">
                Premium agricultural products and expert guidance to help your farm thrive in the modern age.
              </p>
            ...
            {[
              {
                ...
                description: "Only the best agricultural products sourced from trusted suppliers",
                icon: "🌱",
                color: "from-green-400 to-green-500"
              },
              {
                title: "Expert Guidance",
                description: "24/7 support from agricultural experts to help you succeed",
                icon: "👨‍🌾",
              ...
              >
                <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${feature.color} flex items-center justify-center text-3xl mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6`}>
                  {feature.icon}
                </div>
                <h3 className="text-xl font-semibold mb-4 transition-colors duration-300 group-hover:text-green-700">{feature.title}</h3>
                <p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-800">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
                quote: "AgroSphere has transformed our farming operations. Their products and support are exceptional!",
                author: "John Smith",
                role: "Organic Farmer"
              },
              {
                quote: "The quality of products and customer service is unmatched. Highly recommended!",
              ...
              >
                ...
                <div className="font-semibold text-green-700">{testimonial.author}</div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Join thousands of successful farmers who trust AgroSphere for their agricultural needs
          </p>
